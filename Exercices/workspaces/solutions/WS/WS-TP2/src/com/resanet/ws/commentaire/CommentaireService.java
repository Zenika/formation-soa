...
public class CommentaireService extends Service {
    ...
    static {
        URL url = CommentaireService.class.getResource("wsdl/commentaire.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(CommentaireService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "wsdl/commentaire.wsdl");
        }       
        WSDL_LOCATION = url;
    }
